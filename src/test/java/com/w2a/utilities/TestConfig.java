...
public class TestConfig{
	...
	public static String from = "ajaybhandarytest@gmail.com";
	public static String password = "gmailajtest2020";
	public static String[] to ={"ajaybhandarytest@gmail.com","ajaybhandary@gmail.com"};
